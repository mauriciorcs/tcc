...
# name2save = 'tmax_muni_mensal.shp'
name2save = 'preci_muni_mensal.shp'

# caminho dos arquivos NetCDF da grade BR-DWGD
path_netcdf = r"C:\Users\Mauricio\tcc-mauricio\script\netcdf_files"
#path_netcdf = '/home/alexandre/Dropbox/grade_2020/grade_2020-07_2023/data/netcdf_new_dtype/'
# print(path_netcdf + nvar2get + '*.nc')
# var = xr.open_mfdataset(path_netcdf + nvar2get + '*.nc')[nvar2get]
arquivos_nc = glob.glob(os.path.join(path_netcdf, f"{nvar2get}*.nc"))

if arquivos_nc:
    var = xr.open_mfdataset(arquivos_nc)[nvar2get]
    print("Arquivos Carregados com Sucsso")
else:
    print(f"Não encontrado em{path_netcdf}")

# pegando o arquivo shape dos municipios
#path = os.path.join(os.getcwd(), 'shape_file/BR_Municipios_2023.shp')
path = r"C:\Users\Mauricio\tcc-mauricio\script\shape_file\BR_Municipios_2023.shp"
